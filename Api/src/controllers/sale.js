...
var controllerSale = {
    ...
    getSales: (req,res) => {
        ...
        connection.query('SELECT * FROM sales WHERE date like ?',[saleDate], (err, result) => {
    ...
    getDates: (req,res) => {
        connection.query('SELECT date FROM sales', (err, result) => {
            if(err) return res.status(500).send({ message: 'error al cargar' })
    ...
    addSale: (req,res) => {
        ...
        connection.query('INSERT INTO sales SET ?',[newSale], (err,result) => {
    ...
    deleteSale: (req,res) => {
        ...
        connection.query('DELETE FROM sales WHERE id = ?',[saleId], (err,result) => {
